...
public class CheckWriteIdleChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel socketChannel) throws Exception {
        ...
        channelPipeline.addLast("idle", new IdleStateHandler(0, 5, 0, TimeUnit.SECONDS));
